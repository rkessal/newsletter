...
class Vue_FO_NewsLetter_Desinscription implements interface_ComposantVues {
	...
	{
		$str = '
		<h3>Desincription à la news letter</h3><br>
<form>
  <div class="form-group row">
    <label for="exampleInputEmail1" class="col-sm-2 col-form-label">Mail</label>
	<div class="col-sm-10">
		<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Entrez le mail à desinscrire" name="mail"';
