...
class Vue_BO_Mail_Rediger implements interface_ComposantVues {
	...
	{
		$str = '
		<h3>Rédaction d\'un article</h3><br>
<form>
  <div class="form-group row">
    <label for="exampleInputEmail1" class="col-sm-2 col-form-label">Objet</label>
	<div class="col-sm-8">
		<input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Titre de l\'article" name="objet"';
